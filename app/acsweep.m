...
% Open device (auto-detects port and baud rate)
% printf("Opening DDSLI device...\n");
ddsli_open();

% Format and send command
% Command format: f<freq_a>af<freq_b>bf<sweep_rate_a>qf<sweep_rate_b>g
